        ...
        <div class="container mx-auto px-6 lg:px-12">
            <div class="text-center mb-16">
                ...
                <h2 class="text-4xl lg:text-5xl font-bold text-gray-900 mb-4"
                    style="font-family: &quot;Playfair Display&quot;, serif;">Latest Articles &amp; Health Tips
                </h2>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($posts as $p)
                    <article
                        class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer group">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                <div class="flex items-center gap-2">
                                    <div
                                        class="w-8 h-8 bg-gradient-to-br from-cyan-500 to-teal-500 rounded-full flex items-center justify-center">
                                        <i class="ri-user-line text-white text-sm"></i>
                                    </div>
                                    <span class="text-sm font-medium text-gray-700">{{ $doctor->name }}</span>
                                </div>
                                <a href="{{ route('articles.show', $p->slug) }}"
                                    class="text-cyan-600 font-semibold text-sm flex items-center gap-1 hover:gap-2 transition-all whitespace-nowrap">
