                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" 
                                  ...
                                  rows="3" 
                                  placeholder="Brief description...">{{ old('description', $package->description) }}</textarea>
                        @error('description')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div>
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               name="price_monthly" 
                               class="form-control" 
                               value="{{ old('price_monthly', $package->price_monthly) }}" 
                               step="0.01" 
                               min="0" 
                               placeholder="0.00" 
                               required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               name="price_yearly" 
                               class="form-control" 
                               value="{{ old('price_yearly', $package->price_yearly) }}" 
                               step="0.01" 
                               min="0" 
                               placeholder="0.00">
                        @error('price_yearly')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               name="storage_gb" 
                               class="form-control" 
                               value="{{ old('storage_gb', $package->storage_gb) }}" 
                               min="1" 
                               placeholder="10" 
                               required>
                        @error('storage_gb')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               name="max_doctors" 
                               class="form-control" 
                               value="{{ old('max_doctors', $package->max_doctors) }}" 
                               min="1" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               name="max_patients" 
                               class="form-control" 
                               value="{{ old('max_patients', $package->max_patients) }}" 
                               min="1" 
                               placeholder="Leave empty for unlimited">
                        @error('max_patients')
                            <div class="error-message">{{ $message }}</div>
