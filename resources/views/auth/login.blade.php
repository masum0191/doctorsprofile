...
<body class="bg-gray-100 dark:bg-gray-900 flex items-center justify-center min-h-screen px-4">
    <div class="w-full max-w-md p-8 bg-white dark:bg-gray-800 shadow-md rounded-lg">
        ...
        <div class="flex justify-center mb-6">
            <img src="{{ url(@$setting->site_logo) }}" alt="Logo" class="h-12" />
        </div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <!-- Email Address -->
            <div>
                <label for="nid" class="block font-medium text-sm text-gray-700 dark:text-gray-300">NID/Email</label>
                <input id="nid" type="nid" name="nid" value="{{ old('nid') }}" required autofocus autocomplete="username"
