    ...
    <div class="w-full max-w-[90%] xs:max-w-sm sm:max-w-md md:max-w-lg lg:max-w-md relative z-10">
        ...
        <?php if(session('success')): ?>
            <div class="mb-4 sm:mb-6 rounded-lg sm:rounded-xl bg-emerald-50 border border-emerald-200 p-3 sm:p-4 flex items-center gap-2 sm:gap-3">
                ...
                <p class="text-xs sm:text-sm text-emerald-700"><?php echo e(session('success')); ?></p>
            </div>
        <?php endif; ?>
        ...
        <?php if($errors->any() && !($errors->has('email') || $errors->has('password'))): ?>
            <div class="mb-4 sm:mb-6 rounded-lg sm:rounded-xl bg-rose-50 border border-rose-200 p-3 sm:p-4 flex items-center gap-2 sm:gap-3">
                ...
                <p class="text-xs sm:text-sm text-rose-700"><?php echo e(__('These credentials do not match our records.')); ?></p>
            </div>
        <?php endif; ?>
        ...
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div class="p-4 sm:p-6 md:p-8">
                <form method="POST" action="<?php echo e(route('admin.login.submit')); ?>" class="space-y-4 sm:space-y-5 md:space-y-6">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center justify-between gap-3 xs:gap-0">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('admin.password.request')); ?>" class="text-xs sm:text-sm text-[#318069] hover:text-[#276854] font-medium flex items-center gap-1">
                                Forgot password?
...
<?php echo $__env->make('layouts.sass', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\doctorprofiles\resources\views/admin/login.blade.php ENDPATH**/ ?>