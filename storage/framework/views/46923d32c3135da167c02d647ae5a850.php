                    ...
                    <div class="col-span-6">
                        <a href="<?php echo e(url('/')); ?>">
                            <img alt="Doctor Directory Logo" class="h-8 md:h-12  w-auto object-contain"
                                src="<?php echo e(url($siteLogo)); ?>" onerror="this.onerror=null;this.src='<?php echo e(url($fallbackLogo)); ?>';">
                        </a>
                    </div>
                    <!-- <div class="col-span-6">
            ...
            <div class="relative z-10 bg-[#4e9480] py-20">
                <div class="max-w-7xl mx-auto px-6">
                    ...
                    <div class="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <!-- Brand -->
                        <div>
                            <img src="<?php echo e(url($siteLogo)); ?>" class="h-16 mb-6 filter invert brightness-0"
                                onerror="this.onerror=null;this.src='<?php echo e(url($fallbackLogo)); ?>';"
        ...
        (function() {
            ...
            function initMap(lat, lng) {
                ...
                if (typeof L === 'undefined') {
                    mapEl.innerHTML = `
                        <div class="h-full flex items-center justify-center bg-gray-50 text-center px-4 text-xs text-gray-500">
                            Map is loading. You can still select country and city.
                        </div>`;
                    return;
                }
    ...
    try {
        ...
        return null;
            ...
            function openLocationModal() {
                ...
                locationModal.style.removeProperty('display');
        ...
        document.querySelectorAll('#locationModal .close-modal-btn, #locationModal .ri-close-line')?.forEach(btn => {
            ...
            const handleLocationPickerOpen = (event) => {
                event.preventDefault();
                event.stopPropagation();
                openLocationModal();
            };

            locationMapButton?.addEventListener('click', handleLocationPickerOpen);
            locationSelectorEl?.addEventListener('click', handleLocationPickerOpen);
            locationSelectorEl?.addEventListener('keydown', (event) => {
                if (event.key === 'Enter' || event.key === ' ') {
                    handleLocationPickerOpen(event);
                }
            });
