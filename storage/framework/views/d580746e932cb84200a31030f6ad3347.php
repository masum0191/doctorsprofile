    ...
    <div class="bg-white rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] p-4 sm:p-6 md:p-8 max-w-5xl mx-auto border border-[#318069]/20">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div class="md:col-span-3 relative">
                <div id="locationSelector" data-location-fixed="false" role="button" tabindex="0" class="flex items-center bg-gray-100 rounded-2xl px-5 py-4 border-2 border-transparent focus-within:border-[#318069] focus-within:bg-white transition-all cursor-pointer">
